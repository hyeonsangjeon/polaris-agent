...
## v0.2 release checkpoint

Recorded at `2026-07-11T12:18:54Z`, immediately after publishing the
`v0.2.0` prerelease:
...
The project has not begun broad promotion. This checkpoint keeps memory,
scheduler, and channel launch work from being mistaken for organic growth.
